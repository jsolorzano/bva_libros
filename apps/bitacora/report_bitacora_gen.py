...
def gen_res_bitacora(diccionario, usuario, fecha):
    ...
    pdf.cell(120, 5, "ACCIÓN".decode("UTF-8"), 'LTBR', 0, 'C', 1)
    ...
    for accion in diccionario:
        ...
        pdf.cell(30, 5, accion[1].decode("UTF-8"), 'LTBR', 0, 'C', 1)
        pdf.cell(120, 5, accion[0].encode("UTF-8").decode("UTF-8"), 'LTBR', 0, 'C', 1)
        pdf.cell(40, 5, str(accion[2]), 'LTBR', 1, 'C', 1)

        j = j + 1

    nombre_archivo = 'bitacora_'+usuario+'.pdf'
