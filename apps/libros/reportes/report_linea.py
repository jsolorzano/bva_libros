...
def gen_res_linea(agremiados, fecha, datos_linea):
    ...
    pdf.cell(81, 5, "NOMBRE COMPLETO".decode("UTF-8"), 'LTBR', 0, 'C', 1)
    ...
    for agremiado in agremiados:
        ...
        pdf.cell(10, 10, str(k), 'LTBR', 0, 'C', 1)
        pdf.cell(30, 10, cedula, 'LTBR', 0, 'R', 1)
        pdf.cell(81, 10, nombre.encode("UTF-8").decode("UTF-8"), 'LTBR', 0, 'L', 1)
        pdf.cell(20, 10, str(edad)+" AÑOS".decode("UTF-8"), 'LTBR', 0, 'R', 1)
        pdf.cell(40, 10, tel, 'LTBR', 1, 'R', 1)
