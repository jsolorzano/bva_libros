    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cod_editorial', models.CharField(unique=True, max_length=15, verbose_name=b'C\xc3\xb3digo de la editorial')),
                ('editorial', models.CharField(max_length=200, verbose_name=b'Editorial')),
